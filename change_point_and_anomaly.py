...
def update_p_a_t(p_a, sigma_o, sigma_e, y_t, mu_t, gamma_t):
    distr_1 = dist.Normal(mu_t + gamma_t,sigma_o)
...
def generate_z_a_t(p_a, sigma_o, sigma_e, y_t, mu_t, gamma_t):
...
def segment_control(z_c, mu, sigma_r, l):
    ...
    t_change_points = torch.nonzero(z_c)[:]
